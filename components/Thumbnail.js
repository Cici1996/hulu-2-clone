...
const Thumbnail = forwardRef(({ item }, ref) => {
    ...
    return (
        <div ref={ref} className="group cursor-pointer p-2 transition duration-200 ease-in-out transform sm:hover:scale-105 hover:z-50">
            <Image layout="responsive" src={`${baseURL}${item.backdrop_path || item.poster_path}`} height={1080} width={1920} />
            <div className="p-2">
